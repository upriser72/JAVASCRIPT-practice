...
// console.log("2" > 1);  //true(string gets converted to number)
...
console.log(undefined > 0); //undefined is incomparable
console.log(undefined < 0);

// === 
console.log("2"==2) //true coz string gets converted to number
console.log("2" === 2); //false
// === means strict check where not only the numbers but datatype also gets compared
